      ...
      <View style={[styles.container, {flex: 1, justifyContent: 'space-between'}]}>
          ...
          >
            ...
            <View style={[styles.container, {flex: 1, justifyContent: 'center'}]}>
              ...
              <Text style={styles.rulesText}>Get three in a row with any three of different sizes!</Text>
              <Text style={styles.rulesText}>either: big, medium, small</Text>
              <Text style={styles.rulesText}>OR...</Text>
            </View>
            <View style={[styles.container, {flex: 1}]}>
